...
// Mapa explícito: índice date('N') → clave exacta del ENUM en BD (sin tildes)
// date('N'): 1=Lun, 2=Mar, 3=Mié, 4=Jue, 5=Vie, 6=Sáb, 7=Dom
$dia_bd_map = [
    1 => 'lunes',
    2 => 'martes',
    3 => 'miercoles',
...
try {
    ...
    // Clave del día de hoy exacta al ENUM de BD
...
// Clave del día de hoy para el JS (mismo formato que $mapa_eventos)
    ...
    <div class="content-grid">
        ...
        <div class="calendar-card">
            ...
            <div class="calendar-grid">
                ...
                <?php for ($dia = 1; $dia <= $dias_en_mes; $dia++):
                    ...
                    $dia_key         = $dia_bd_map[$dow];                    // clave exacta BD
                    ...
                    $onclick         = $total_eventos > 0
                        ...
                        : "abrirModal('$dia_key')";
                ?>
                    <div class="day <?php echo $clase_hoy; ?>" onclick="<?php echo $onclick; ?>" title="<?php echo "$nombre_dia_full $dia_label"; ?>">
        ...
        <div class="help-card">
            ...
            <div class="help-items">
                ...
                <!-- Leyenda "Día actual" clickeable -->
                <div class="help-legend"
                     onclick="irHoy()"
                     title="Ver horarios de hoy">
...
function irHoy() {
    ...
    if (eventos.length > 0) {
        ...
        // No hay clases hoy → abrir modal para crear con el día preseleccionado
        abrirModal(HOY_KEY);
    }
}
...
(function () {
    ...
    function syncMargin() {
        // El header de Amimbré añade la clase 'sidebar-collapsed' al <body>
        // o directamente a .sidebar cuando se colapsa.
        // Comprobamos ambas convenciones habituales.
        const collapsed =
    ...
    // Observar cambios de clase en body y en .sidebar
