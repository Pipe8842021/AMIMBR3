...
try {
    ...
    error_log("Erro r al obtener datos de usuario: " . $e->getMessage());
...
<body>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <span class="stat-detail"><?php echo $usuarios_activos; ?> activos,
                        <?php echo $usuarios_inactivos; ?> inactivos</span>
                </div>
            </div>
            ...
            <form method="GET" class="filters-form">
                ...
                <div class="filter-group">
                    <select name="rol" id="filtro-rol">
                        <option value="admin" <?php echo $filtro_rol === 'admin' ? 'selected' : ''; ?>>Administradores
                        </option>
                        <option value="profesor" <?php echo $filtro_rol === 'profesor' ? 'selected' : ''; ?>>Profesores
                        </option>
                        <option value="estudiante" <?php echo $filtro_rol === 'estudiante' ? 'selected' : ''; ?>>
                            Estudiantes</option>
                    </select>
                ...
                <div class="filter-group">
                    <select name="estado" id="filtro-estado">
                        ...
                        <option value="activo" <?php echo $filtro_estado === 'activo' ? 'selected' : ''; ?>>Activos
                        </option>
                        <option value="inactivo" <?php echo $filtro_estado === 'inactivo' ? 'selected' : ''; ?>>Inactivos
                        </option>
                    </select>
                    <span class="material-symbols-rounded">expand_more</span>
                </div>
    ...
    <script>
        function toggleMenu(button) {
            // ✅ Solo afecta dropdowns de la TABLA, no del sidebar
            const menu = button.nextElementSibling;
            const allMenus = document.querySelectorAll('.actions-menu .dropdown-menu');
            ...
            // Reposicionar después de mostrar
        ...
        document.addEventListener('click', function (e) {
            if (!e.target.closest('.actions-menu')) {
                document.querySelectorAll('.actions-menu .dropdown-menu').forEach(m => {
