...
try {
    ...
    $stmt = $pdo->prepare("
        ...
        WHERE g.profesor_id = ? AND b.estado = 'borrador'
    ");
    $stmt->execute([$user['id']]);
    $bitacoras_pendientes = $stmt->fetchColumn();
    ...
    error_log("Error obteniendo estadísticas profesor: " . $e->getMessage());
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <a href="../notas/index.php" class="menu-item">
            ...
            <a href="../documentos/index.php" class="menu-item">
                <i class="fas fa-folder-open"></i>
                <span>Documentos</span>
            </a>
            <a href="../reportes/index.php" class="menu-item">
    ...
    <main class="main-content">
        <div class="header">
            <div>
                <h1 class="welcome">¡Bienvenido, Profesor <?php echo htmlspecialchars($user['nombre']); ?>!</h1>
                <p style="color: var(--text-secondary);">Panel de Gestión de Cursos</p>
            </div>
            <div class="user-info">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo $total_estudiantes ?? 0; ?></h3>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo $bitacoras_pendientes ?? 0; ?></h3>
        ...
        <div class="quick-actions">
            ...
            <div class="action-buttons">
                <a href="../bitacoras/crear.php" class="action-btn">
                    <i class="fas fa-plus-circle"></i>
                    <span>Nueva Bitácora</span>
                </a>
                <a href="../notas/cargar.php" class="action-btn">
                ...
                <a href="../reportes/generar_academico.php" class="action-btn">
